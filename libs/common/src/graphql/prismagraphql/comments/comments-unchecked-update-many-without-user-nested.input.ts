...
@InputType()
export class CommentsUncheckedUpdateManyWithoutUserNestedInput {
    ...
    @Field(() => [CommentsUpsertWithWhereUniqueWithoutUserInput], {nullable:true})
    ...
    @Field(() => [CommentsUpdateWithWhereUniqueWithoutUserInput], {nullable:true})
    @Type(() => CommentsUpdateWithWhereUniqueWithoutUserInput)
    update?: Array<CommentsUpdateWithWhereUniqueWithoutUserInput>;

    @Field(() => [CommentsUpdateManyWithWhereWithoutUserInput], {nullable:true})
