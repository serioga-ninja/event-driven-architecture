...
@InputType()
export class CommentsUpdateManyWithoutPostNestedInput {
  ...
  @Field(() => [CommentsUpsertWithWhereUniqueWithoutPostInput], {
    nullable: true,
  })
