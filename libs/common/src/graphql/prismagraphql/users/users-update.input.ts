...
import { CommentsUpdateManyWithoutUserNestedInput } from '../comments/comments-update-many-without-user-nested.input';
...
export class UsersUpdateInput {
    ...
    @Field(() => CommentsUpdateManyWithoutUserNestedInput, {nullable:true})
