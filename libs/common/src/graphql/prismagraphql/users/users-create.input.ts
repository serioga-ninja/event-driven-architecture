...
import { CommentsCreateNestedManyWithoutUserInput } from '../comments/comments-create-nested-many-without-user.input';
...
export class UsersCreateInput {
    ...
    @Field(() => CommentsCreateNestedManyWithoutUserInput, {nullable:true})
